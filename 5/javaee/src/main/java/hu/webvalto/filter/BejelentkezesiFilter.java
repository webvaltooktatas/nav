...
@WebFilter("*")
public class BejelentkezesiFilter implements Filter {
    @Override
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        boolean bejelentkezesiOldal = httpRequest.getRequestURI().endsWith("index.jsp");

        boolean bejelentkezve = (session != null && session.getAttribute("bejelentkezve") != null);

        if (bejelentkezve && (bejelentkezesiKeres || bejelentkezesiOldal)) {
